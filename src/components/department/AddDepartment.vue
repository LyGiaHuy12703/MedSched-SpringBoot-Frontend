    ...
    <va-card class="department-card">
      <va-card-content>
        <va-card-title class="header">
          ...
          <h1 class="va-h4 title-text">Thêm dữ liệu bộ phận</h1>
        </va-card-title>
        <va-form ref="formRef" @submit.prevent="onSubmit">
          <div class="add-grid">
            ...
            <div class="add-item">
              ...
              <va-input
                v-model.number="localDepartmentData.examinationTime"
                type="number"
...
const resetDepartmentData = () => {
  ...
  localDepartmentData.value.examinationTime = undefined
}
